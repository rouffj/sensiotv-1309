    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('terms', Type\CheckboxType::class, [
                'mapped' => false, // Avoid to link this field with the entity.
                'constraints' => [new Assert\IsTrue(['message' => 'You should accepts our terms'])],
            ...
            ->add('createAccount', Type\SubmitType::class, [
